...
import { getOrderByUserIdAsync, resetOrderFetchStatus, selectOrderFetchStatus, selectOrders, deleteOrderByIdAsync, selectOrderDeleteStatus, resetOrderDeleteStatus } from '../OrderSlice'
...
export const UserOrders = () => {
    ...
    const orderDeleteStatus=useSelector(selectOrderDeleteStatus)
    ...
    useEffect(()=>{
        if(orderDeleteStatus==='fulfilled'){
            toast.success("Order deleted successfully")
        }
        else if(orderDeleteStatus==='rejected'){
    ...
    const handleDeleteOrder=(orderId)=>{
        dispatch(deleteOrderByIdAsync(orderId))
    }
                                        ...
                                        <Stack flexDirection={'row'} alignItems={'center'} columnGap={2}>
                                            ...
                                            <motion.div whileHover={{scale:1.1}} whileTap={{scale:0.9}}>
                                                <IconButton 
                                                    ...
                                                    sx={{color: 'error.main'}}
                                                    disabled={orderDeleteStatus==='pending'}
                                                >
                                                    <DeleteIcon />
                                                </IconButton>
                                            </motion.div>
